...
class Player:
    ...
    def init_player(self,x,y):    
        ...
        # Idle
        self.idle = True
        # Estado del juego (0 = Activo, -1 = Perdido, 1 = Inicio)
        self.game_status = 0
        # Nivel
        self.nivel = 1
    ...
    def update(self,screen):
        ...
        if self.game_status == 0:
            ...
            if pygame.sprite.spritecollide(self, exit_group, False):
                ...
                exit_group.empty()
                world_data.clear()
                self.reset(0, SCREEN_HEIGHT/2)

            # Limitar movimiento a la zona de la pantalla
        ...
        elif self.game_status == -1: # Jugador muerto
